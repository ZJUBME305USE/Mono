...
class MonoDataset(data.Dataset):
    ...
    def preprocess(self, inputs, color_aug):
        ...
        for k in list(inputs):
            if "color" in k:
                ...
                for i in range(self.num_scales):
                    inputs[(n, im, i)] = cv2.resize(inputs[(n, im, i - 1)],
        ...
        for k in list(inputs):
            ...
            if "color" in k:
                ...
                f = transforms.ToPILImage()(f.astype(np.uint8))
    ...
    def __getitem__(self, index):
        ...
        loading_image_time = time.time() - start
        ...
        if self.load_depth:
            ...
            loading_gt_time = time.time() - start
        ...
        time_cost = time.time() - start_first
        inputs["all_cost_time"] = time_cost
        inputs["loading_gt_time"] = loading_gt_time
        inputs["loading_image_time"] = loading_image_time
        inputs["preprocess_time"] = process_time
        return inputs
